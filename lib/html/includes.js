...
var MiniProfiler = (function () {
    ...
    var _pageLoc = function(e) { return [e.pageX, e.pageY]; };
    var _dragging = false, _dragWindow = null, _downAt = [0,0], _posAtDown = {left:0, top:0};
    var _up = function() {
      _dragging = false;
    ...
    var _drag = function(e) {
      if (_dragging) {
        var pl = _pageLoc(e), dx = pl[0] - _downAt[0], dy = pl[1] - _downAt[1];
        $(_dragWindow).offset({ left: _posAtDown.left + dx, top:_posAtDown.top + dy });
      }
    };

    var _makeDraggable = function(div) {
      _dragWindow = div;
      div.addEventListener("mousedown", _down);
    };
